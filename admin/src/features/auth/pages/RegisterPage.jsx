...
import { Eye, EyeOff, Loader2, Lock, Mail, User, Phone, Car, CarFront } from "lucide-react";
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background font-sans selection:bg-primary selection:text-primary-foreground">
            ...
            <div className="grid h-screen lg:grid-cols-2">
                ...
                {/* Right Side */}
                <div className="flex h-screen flex-col items-center bg-card overflow-y-auto px-4 py-8">                    <div className="relative w-full max-w-md p-2 sm:p-4">
                    {/* Logo */}
                    ...
                    <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
                        ...
                        >
                            ...
                            <Button
                                ...
                                className="mt-2 h-11 w-full bg-primary text-primary-foreground hover:opacity-90"
                            >
                                {isRegistering ? (
